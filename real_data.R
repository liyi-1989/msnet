...
#plon=-118.2437 ;plat=34.0522; Plon=-120; Plat=35 # LA
#plon=-70.2553 ;plat=43.6615; Plon=-70; Plat=45 # Portland,ME
#plon=-122.3321 ;plat=47.6062; Plon=-120; Plat=50 # Seattle
# plon=-77.0369
# plat=38.9072
...
ctr=list(L = 1, use.gram = TRUE, maxiter = 6000, tol = 1e-5, init = NULL, sigma = 0.9)
